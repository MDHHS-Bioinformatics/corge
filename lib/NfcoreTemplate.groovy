    ...
    public static void summary(workflow, params, log) {
        ...
        if (workflow.success) {
            if (workflow.stats.ignoredCount == 0) {
                ...
                log.info "${colors.biyellow}        / ^ \\   / ^ \\                      ${colors.reset}"
                log.info "${colors.biyellow}        \\ v /___\\ v /                      ${colors.reset}"
                log.info "${colors.biyellow}        /  _ | | _  \\                      ${colors.reset}"
                log.info "${colors.biyellow}       /  -● | | ●-  \\                     ${colors.reset}"
                log.info "${colors.biyellow}       \\ ___/ ● \\___ /                     ${colors.reset}"
                log.info "${colors.biyellow}        (   (_|_)    )                      ${colors.reset}"
                log.info "${colors.biyellow}         \\    U     /__________________/)   ${colors.reset}"
                log.info "${colors.biyellow}          |  '''         wwww wwww     *    ${colors.reset}"
