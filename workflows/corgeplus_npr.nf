...
workflow CORGEPLUS_NPR {
    ...
    //
    CHEWBBACA_ANALYSIS (
        VERIFY_CGMLST_SCHEMES_NPR.out.samples_to_chewbbaca
    )
    ...
    //
    PARSNP_ANALYSIS (
        VERIFY_CGMLST_SCHEMES_NPR.out.samples_to_parsnp,
